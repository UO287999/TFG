...
La figura @fig-ingresos10 muestra la evolución de los ingresos anuales para diferentes personas a lo largo del tiempo, en el que cada línea representa a una persona.
...
Una visión más acertada sería utilizar un modelo que se ajuste a cada individuo, como se hace en la figura @fig-modelo-individual.
