...
Cuando se satisfacen los supuestos del modelo, la regresión lineal simple permite obtener estimaciones consistentes y no sesgadas de los parámetros que describen la relación entre las variables. Además, esta técnica posibilita realizar análisis inferenciales, como contrastes de hipótesis o construcción de intervalos de confianza, para evaluar la significación estadística del efecto de la variable independiente sobre la dependiente.
