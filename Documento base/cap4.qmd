...
ggplot(df_box_01, aes(x = variable, y = valor, fill = variable)) +
  ...
  labs(title = "Variables entre 0 y 1",
       x = "Variable", y = "Valor") +
  theme_minimal() +
...
En términos de libertad para tomar decisiones vitales, Afganistán se sitúa consistentemente por debajo de la media regional. Este valor, que ya era bajo en años anteriores, cae aún más tras 2021, reflejando la pérdida de autonomía percibida por sus ciudadanos.
...
Esta pérdida de libertad se ve reforzada por el deterioro de los derechos políticos, donde Afganistán muestra los valores más altos de privación dentro de la región. El país se convierte en un claro outlier en este aspecto a partir de 2021.
...
Por último, la privación de libertades civiles también coloca a Afganistán en una posición crítica frente a sus vecinos. Este conjunto de restricciones políticas y sociales contribuye directamente a su puntuación tan baja de felicidad, y subraya la necesidad de considerar el contexto institucional al interpretar estos datos.